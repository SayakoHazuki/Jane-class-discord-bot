...
export class MessageCommandInitiator implements CommandInitiator<Message> {
...
export class ChatInputCommandInitiator
    implements CommandInitiator<ChatInputCommandInteraction>
{
...
export class ButtonInitiator implements CommandInitiator<ButtonInteraction> {
